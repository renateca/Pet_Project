...
Suite *add_suite_asin(void) {
  Suite *suit = suite_create("asin");
  TCase *tc_core = tcase_create("Core_test_asin");
  ...
  tcase_add_test(tc_core, test_asin_negative);
  tcase_add_test(tc_core, test_asin_one_negative);
  tcase_add_test(tc_core, test_asin_huge_positive);
  tcase_add_test(tc_core, test_asin_huge_negative);
  tcase_add_test(tc_core, test_asin_big_mantissa);
  tcase_add_test(tc_core, test_asin_nan);
  tcase_add_test(tc_core, test_asin_inf);
